...
inputs_file = open('/home/zhaolei/Projects/SSD_for_SEED_VIG/inputs.pickle', 'rb')
inputs = pk.load(inputs_file)
inputs_file.close() 
outputs_file = open('/home/zhaolei/Projects/SSD_for_SEED_VIG/outputs.pickle', 'rb')
...
torch.save(myModel.state_dict(), './model2.pth')
